...
class fbconnctController extends JController
{
	...
	public static function create_user()
	{
		...
		echo '<div class="username-wrp"><label for="username">Username<input type="text" name="username" class="inputbox" value="'.strtolower($session_me['first_name'].'_'.rand(100,10000)).'" /></label>';
		...
		echo '</fieldset>';
		echo '</div>';
		echo '<span class="note"><a href="'.JRoute::_('index.php?task=switch&option=com_fbconnct&format=raw').'">'.JText::_('COM_FBCONNCT_REFRESH_FBSESSION').'</a> | <a href="http://www.saaraan.com" target="_blank">Saaraan.com</a></span>';
		echo '</html>';
