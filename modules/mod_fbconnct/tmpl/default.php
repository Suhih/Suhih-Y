...
echo '<!-- saaraan.com Facebook Login Start -->';
if($type == 'logout'){
	...
	<a href="http://www.saaraan.com" target="_blank" title="Powered by Saaraan"><img src="'.JRoute::_(JURI::base().'modules/mod_fbconnct/assets/brd.png').'" width="15" height="26" border="0" /></a></div>';
}
echo '<!-- saaraan.com Facebook Login end -->';