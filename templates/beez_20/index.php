...
<body>
  ...
  <a href="#" onclick="window.open('http://sato.home/index.php?option=com_fbconnct&task=login&format=raw','name','height=300,width=550');return false;" >Login with Facebook</a>
